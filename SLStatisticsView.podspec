...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "cslmark"
  # s.authors            = { "cslmark" => "chensl@hadlinks.com" }
  # s.social_media_url   = "http://twitter.com/cslmark"
  ...
  s.source       = { :git => "https://github.com/cslmark/SLStatisticsView.git", :tag => "#{s.version}", :commit => "4caec0735030fe13097b52fe5a844cabe73c2d25" }
